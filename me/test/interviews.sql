...
insert into templates (code, template) values ('me-interviews', '<h1>interviews</h1>
{{#interviews}}
date:{{ymd}}
uri:{{uri}}
title:{{title}}
...
select plan(1);
select is(body, '<title>interviews with Derek Sivers</title><body><h1>interviews</h1>
date:2026-02-03
uri:2026-02-03-two
title:Two Man
