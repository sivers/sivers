...
insert into templates(code, template) values ('headfoot', '<html><head><title>{{pagetitle}}</title></head><body>{{{core}}}</body></html>');
...
select is('<html><head><title>TEST</title></head><body><h1>Derek</h1><ul><li>a</li><li>b</li></ul></body></html>',
	o.template('headfoot', jsonb_build_object('pagetitle', 'TEST', 'core',
