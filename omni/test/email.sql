...
insert into people (id, name, greeting) values (3, 'MISSING AN EMAIL', 'you fool');
...
select is(
	o.email(1, 3, 'what happened to you?', 'why no email?', null)
	, null, 'person has no email address? just return null');
